...
Frozen on 2026-09-20 (Week 4 gate passed: best dev graph arch val MAE 0.1688 <= 1.10 x 0.1722, the best W2 graph-blind arch).
...
- Not part of the 50: the W2 five graph-blind archs (`results/archs_w2.jsonl`, space dartsts_v1; timing / seed-noise data) and the W3 dev archs (`results/archs_dev.jsonl`, seed 100; gate data)
