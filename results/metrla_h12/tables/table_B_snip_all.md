...
|---|---|---|---|---|---|---|
| snip_all alone (under A) | 50 | -0.39 (-0.62, -0.08) | -0.26 | -0.32 | -0.26 | no |
| S_spatial (snip_all) | 50 | -0.13 (-0.42, 0.19) | -0.09 | -0.34 | -0.48 | no |
| z_spatial (snip_all) | 50 | -0.21 (-0.48, 0.08) | -0.17 | -0.30 | -0.36 | no |
| composite = z(snip_all) + z(S_spatial) | 50 | -0.44 (-0.64, -0.17) | -0.29 | -0.47 | -0.44 | no |
| composite = z(snip_all) + z(z_spatial) | 50 | -0.42 (-0.64, -0.16) | -0.27 | -0.46 | -0.44 | no |
