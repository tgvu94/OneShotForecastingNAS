...
|---|---|---|---|---|---|---|
| grad_norm_all alone (under A) | 50 | -0.25 (-0.51, 0.02) | -0.16 | -0.24 | -0.21 | no |
| S_spatial (grad_norm_all) | 50 | -0.09 (-0.39, 0.21) | -0.07 | -0.35 | -0.42 | no |
| z_spatial (grad_norm_all) | 50 | -0.05 (-0.35, 0.23) | -0.03 | -0.28 | -0.31 | no |
| composite = z(grad_norm_all) + z(S_spatial) | 50 | -0.30 (-0.56, -0.02) | -0.20 | -0.44 | -0.41 | no |
| composite = z(grad_norm_all) + z(z_spatial) | 50 | -0.25 (-0.53, 0.05) | -0.17 | -0.47 | -0.45 | no |
