...
|---|---|---|---|---|---|---|
| snip_all alone (under A) | 300 | -0.14 (-0.24, -0.02) | -0.09 | -0.05 | -0.08 | no |
| S_spatial (snip_all) | 300 | 0.21 (0.11, 0.32) | 0.15 | -0.14 | -0.17 | no |
| z_spatial (snip_all) | 300 | 0.15 (0.04, 0.25) | 0.10 | -0.24 | -0.32 | no |
| composite = z(snip_all) + z(S_spatial) | 300 | -0.09 (-0.19, 0.03) | -0.06 | -0.14 | -0.18 | no |
| composite = z(snip_all) + z(z_spatial) | 300 | -0.07 (-0.18, 0.05) | -0.05 | -0.28 | -0.35 | no |
